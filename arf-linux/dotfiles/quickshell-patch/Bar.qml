          ...
          Row {
            ...
            Rectangle {
              ...
              MouseArea {
                ...
                acceptedButtons: Qt.LeftButton
                onClicked: {
                  if (SystemInfo.networkType === "wifi" || SystemInfo.networkType === "disconnected") {
                    wifiToggleProc.command = SystemInfo.networkType === "wifi"
            ...
            Rectangle {
              ...
              color: root.theme.bgSurface
              Accessible.role: Accessible.Button
              Accessible.name: "Bluetooth: " + (SystemInfo.bluetoothOn ? "On" : "Off") + ", click to toggle"
              ...
              Row {
                ...
                Text {
                  anchors.verticalCenter: parent.verticalCenter
                  text: SystemInfo.bluetoothOn ? "󰂯" : "󰂲"
                  color: SystemInfo.bluetoothOn ? root.theme.accentPrimary : root.theme.textMuted
                  font.pixelSize: 14
                  font.family: root.font
                }
                Text {
              ...
              MouseArea {
                ...
                acceptedButtons: Qt.LeftButton
                onClicked: {
                  bluetoothToggleProc.command = SystemInfo.bluetoothOn
